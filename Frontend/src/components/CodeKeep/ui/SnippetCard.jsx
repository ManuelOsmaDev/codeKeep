        ...
        >
            ...
            >
                <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className={`w-10 h-10 ${languageColors[snippet.language]} rounded-lg flex items-center justify-center flex-shrink-0 text-white`}>
                        {getLanguageIcon(snippet.language)}
                    </div>
                    <h3 className="font-semibold text-base truncate" style={{ color: '#2e3549' }}>{snippet.title}</h3>
                </div>
            ...
            <div className="p-4 pt-3">
                ...
                <div className="flex items-center gap-2">
                    {canEdit && onEdit && (
                        <button
                            onClick={() => onEdit()}
                            className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm transition-colors font-medium"
                            style={{ backgroundColor: '#ffcd00', color: '#2e3549' }}
                        >
